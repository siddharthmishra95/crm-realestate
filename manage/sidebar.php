          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="layouts-with-navbar.php" class="menu-link">
                    <div data-i18n="Without navbar">Navbar</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="manage-slider.php" class="menu-link">
                    <div data-i18n="Container">Slider</div>
                  </a>
                </li>


                <li class="menu-item">
                  <a href="manage-about.php" class="menu-link">
                    <div data-i18n="Container">About</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="manage-services.php" class="menu-link">
                    <div data-i18n="Fluid">Our Services</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="manage-property.php" class="menu-link">
                    <div data-i18n="Blank">Property List & Post</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="manage-agents.php" class="menu-link">
                    <div data-i18n="Blank">Best Agents</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="manage-news.php" class="menu-link">
                    <div data-i18n="Blank">Latest News</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="manage-testimonials.php" class="menu-link">
                    <div data-i18n="Blank">Testimonials</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="manage-clients.php" class="menu-link">
                    <div data-i18n="Blank">Our Client</div>
                  </a>
                </li>
